    ...
    var i = function () {
      ...
      return i(e, [{
        key: "addToken", value: function (e) {
          ...
          if (e.token && (e = e.token), "DEV" === e.slice(0, 3))return this.logger.info("dev tokens cannot be saved to a user as they are a temporary resource"), !1;
          if (h.isAndroidDevice() ? t = "android" : h.isIOSDevice() && (t = "ios"), null === t || !this.tokens.hasOwnProperty(t))return this.logger.info("cannot determine the token platform. Are you running on an Android or iOS device?"), !1;
      ...
      return i(e, [{
        ...
        key: "checkForNotifications", value: function () {
          ...
          var e = this, t = {
            ...
            headers: {Accept: "application/json", "Content-Type": "application/json", "X-Ionic-Dev-Token": this._token},
            json: !0
          };
  ...
  30: [function (e, t, n) {
    ...
    var i = function () {
      ...
      function e(t) {
        ...
        if (this.app = n, this.registerCallback = !1, this.notificationCallback = !1, this.errorCallback = !1, this._token = !1, this._notification = !1, this._debug = !1, this._isReady = !1, this._tokenReady = !1, this._blockRegistration = !1, this._registered = !1, this._emitter = new c.EventEmitter, t !== v) {
          var i = this;
